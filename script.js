...
const questions = [
  [
    ...
    },
    {
      ...
      status: 0,
      question:
        'Empieza por I: Objeto magnético que puede atraer al hierro y a otros metales.',
    },
    {
      letter: 'j',
      answer: 'judion',
  ...
  [
    {
      ...
      status: 0,
      question:
        'Empieza por A: Conjunto de las letras de un idioma puestas en orden.',
    },
    {
      letter: 'b',
      answer: 'babero',
      status: 0,
      question:
        'Empieza por B: Tela que se pone a los bebés en el pecho para que no se manchen al comer.',
    },
    {
      letter: 'c',
      answer: 'cabeza',
      status: 0,
      question:
        'Empieza por C: Parte superior del cuerpo que está sobre el cuello.',
    },
    {
      letter: 'd',
      answer: 'dormir',
      status: 0,
      question:
        'Empieza por D: Forma de descanso que hacemos por las noches o en la siesta, con los ojos cerrados, sin darnos cuenta de nada.',
    },
    {
      letter: 'e',
      answer: 'elefante',
      status: 0,
      question:
        'Empieza por E: Animal mamífero enorme, de color marrón o gris, que vive en Asia o África, y que tiene trompa y grandes orejas.',
    },
    {
      letter: 'f',
      answer: 'fiebre',
      status: 0,
      question:
        'Empieza por F: Aumento de la temperatura del cuerpo que tenemos cuando estamos enfermos.',
    },
    {
      letter: 'g',
      answer: 'globo',
      status: 0,
      question:
        'Empieza por G: Especie de pelota de goma, que se hincha con aire, y que a veces los niños llevan flotando atado con una cuerda.',
    },
    {
      letter: 'h',
      answer: 'humo',
      status: 0,
      question: 'Empieza por H: Lo que sale cuando se hace un fuego.',
    },
    {
      letter: 'i',
      answer: 'iglesia',
      status: 0,
      question:
        'Empieza por I: Lugar en el que se hacen las misas, las bodas, los bautizos, las comuniones,...',
    },
    {
      letter: 'j',
      answer: 'jardin',
      status: 0,
      question:
        'Empieza por J: Zona que rodea algunas casas o edificios y que está lleno de césped, flores, árboles...',
    },
    {
      letter: 'l',
      answer: 'luna',
      status: 0,
      question:
        'Empieza por L: Satélite de la Tierra, de color blanco, que se ve por la noche.',
    },
    {
      letter: 'm',
      answer: 'mantel',
      status: 0,
      question:
        'Empieza por M: Tela que se pone en las mesas a la hora de comer.',
    },
    {
      letter: 'n',
      answer: 'nido',
      status: 0,
      question:
        'Empieza por N: Tipo de casa que construyen los pájaros para poner sus huevos.',
    },
    {
      letter: 'ñ',
      answer: 'ñu',
      status: 0,
      question:
        'Contiene la Ñ: Mamífero africano de color marrón parecido a un toro con los cuernos curvos.',
    },
    {
      letter: 'o',
      answer: 'ojo',
      status: 0,
      question:
        'Empieza por O: Órgano del sentido de la vista. Lo que usamos para ver.',
    },
    {
      letter: 'p',
      answer: 'peces',
      status: 0,
      question:
        'Empieza por P: Animales que viven en el agua, cubiertos de escamas, con aletas para nadar.',
    },
    {
      letter: 'q',
      answer: 'queso',
      status: 0,
      question:
        'Contiene la Q: Alimento de color amarillento que se fabrica con leche, y que se come en trozos, lonchas, en la pizza, rallado,...',
    },
    {
      letter: 'r',
      answer: 'rapido',
      status: 0,
      question: 'Empieza por R: Veloz.',
    },
    {
      letter: 's',
      answer: 'sacapuntas',
      status: 0,
      question:
        'Empieza por S: Lo que usas para que tus lápices tengan la punta afilada.',
    },
    {
      letter: 't',
      answer: 'tenedor',
      status: 0,
      question:
        'Empieza por T: Objeto que se usa para pinchar los alimentos y comérselos.',
    },
    {
      letter: 'u',
      answer: 'uña',
      status: 0,
      question:
        'Empieza por U: Parte dura que está en la punta de los dedos, que cortamos cuando crece y que las mujeres se pintan a veces.',
    },
    {
      letter: 'v',
      answer: 'verano',
      status: 0,
      question: 'Empieza por V: Estación del año en la que hace mucho calor.',
    },
    {
      letter: 'x',
      answer: 'taxi',
    ...
    },
    {
      ...
      answer: 'yate',
      status: 0,
      question: 'Empieza por Y: Barco de lujo.',
    },
    {
      letter: 'z',
      answer: 'zoo',
      status: 0,
      question:
        'Empieza por Z: Parque en el que hay todo tipo de animales de todo el mundo que se pueden visitar por el público.',
    },
  ],
  [
    {
...
document
  .querySelector('.answer-verify')
  .addEventListener('click', verifyAnswer, false);
document
  .querySelector('.start-button')
  .addEventListener('click', starGame, false);
...
document
  .querySelector('.player-name-button')
  .addEventListener('click', savePlayerName, false);
...
function game() {
  ...
  if (playerQuestions[letterId].status == 0) {
    ...
    document.getElementsByClassName('question-text')[0].innerHTML =
      playerQuestions[letterId].question;
    letterStyle = document.getElementsByClassName('letter' + letterId)[0];
    document
      .querySelector('.letter' + letterId)
...
function verifyAnswer() {
  ...
  if (answer == playerQuestions[letterId].answer) {
    ...
    document.querySelector('.question-text').innerHTML =
      playerQuestions[letterId].question;
    document.querySelector('.right-answer').innerHTML =
      'La respuesta correcta es: ' + playerQuestions[letterId].answer;
    setTimeout(() => {
  ...
  if (total === playerQuestions.length) {
    ...
    resetCurrentLetterStyle();
    document.querySelector('.question-text').innerHTML =
      "HAS ACABADO. Pulsa 'Finalizar Juego' para ver el ranking";
    setTimeout(() => {
...
function resetCurrentLetterStyle() {
...
function generateRanking() {
  document.getElementsByClassName('ranking-wrapper')[0].innerHTML =
    '### RANKING ###';
  for (const element of players) {
    let rankingDiv = document.createElement('div');
    rankingDiv.className = 'ranking';
    rankingDiv.innerHTML = element.name + ' - ' + element.score + ' PUNTOS';
    document
      .getElementsByClassName('ranking-wrapper')[0]
      .appendChild(rankingDiv);
  }
}
